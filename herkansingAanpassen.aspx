<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="herkansingAanpassen.aspx.cs" Inherits="aspPVBopdracht.WebForm11" %>
            ...
            <td>
                ...
                <table style="width: 600px; margin: 50px auto 50px auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList1" Width="169px" runat="server"></asp:DropDownList></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:Button ID="Button1" runat="server" Text="Aanpassen" /></td>
                    </tr>
                </table>
